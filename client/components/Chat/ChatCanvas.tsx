...
// Add these helper functions before the ChatCanvas component
const splitTextByDocuments = (text: string): { text: string; documentId: string | null }[] => {
    if (!text) return [];
...
// Add this helper function to handle document click
const handleDocumentClick = (doc: Document, chapters: Chapter[], setViewerMode: Function) => {
    if (doc.lecture) {
        setViewerMode({
            active: true,
            documentId: doc.id,
...
// Add this helper function to format document label
const getDocumentLabel = (doc: Document, lectures: any[], textbooks: any[]) => {
    if (doc.lecture) {
...
// Add this function to handle consecutive document grouping
const groupConsecutiveDocuments = (segments: { text: string; documentId: string | null }[], allDocuments: Document[]) => {
...
// Add this helper function alongside other helper functions
const splitTextByFigures = (text: string): { text: string; figureId: string | null }[] => {
    if (!text) return [];
