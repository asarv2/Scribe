/**
 * SimpleGenerateForm.tsx
 * Just like GenerateForm.tsx, but with reduced sections
 * @AshokSaravanan
 * 2025-01-23
 */
...
export default function SimpleGenerateForm({ classId, type }: { classId: string, type: 'problems' | 'summary' }) {
