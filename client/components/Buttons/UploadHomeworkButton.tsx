...
export default function UploadHomeworkButton({ classId, icon = false, initalStatus = "parsing" }: { classId: string, icon?: boolean, initalStatus?: ParseStatus }) {
    ...
    return (
        <>
            {icon ? <Tooltip label="Upload Homework">
                <ActionIcon
                    size="md"
                    variant="subtle"
