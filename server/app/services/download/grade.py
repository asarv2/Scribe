...
class GradeDownloader:
    ...
    def download_pdf(self):
        ...
        success = self.save_grade_pdf(
            grade_dir, base_filename, title=self.grade["title"]
        )
    ...
    def download_latex(self):
        ...
        success = self.save_grade_pdf(
            grade_dir, base_filename, title=self.grade["title"], pdf=False
        )
    ...
    def save_grade_pdf(
        self, directory: str, base_filename: str, title: str, pdf: bool = True
    ):
        """
        ...
        with doc.create(Section("Grade Results")):
            ...
            for i, (result, feedback) in enumerate(
                zip(self.grade["results"], self.grade["feedback"])
            ):
