...
class adherenceEvaluator():
    ...
    def _initialize_evaluation_prompts(self):
        base_question_prompt = f"""You are a professor for the class {self.class_title} and you have been asked to evaluate a problem or summary generated by an AI model."""
