...
class LearnAgent:
    def __init__(self):
        ...
        self.system_prompt = (
            "You are the Learn Agent. Your goal is to help univesrity students learn and understand any part of the course material and content they may not know or be confused about.\n"
