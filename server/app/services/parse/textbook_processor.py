...
class TextbookProcessor(BaseProcessor):
    ...
    def _get_base_prompt(self) -> str:
        ...
        example_latex = '''
        <LATEX>\\textbf{Thm 10.1} \\quad $S$ is convex if and only if
        ...
        if self.handwritten:
            ...
            2. Find any important figures on the pages and provide the 4 bounding box coordinates: [ymin, xmin, ymax, xmax]Use <FIGURE> and </FIGURE> tags to enclose the figure coordinates. If there are no figures present, simply do not write any <FIGURE> tags. Example:
            <FIGURE [200, 90, 745, 527]>A description of the figure.</FIGURE>
            
            3. Provide a text based description of what you see, including specific details that would not be known unless you were given the context of the page. Be very detailed and specific, but make sure to stay concise and to the point. Use LaTeX to describe any mathematical content you see on the page. Use <DESCRIPTION> and </DESCRIPTION> tags to enclose the description. Example:
            {example_description}'''
        else:
            instructions = f'''Follow the 2 instructions carefully to extract the content from the textbook for the following course: {self.course_title}.
            1. Re-create the content exactly as it is written on the textbook in LaTeX format, preserving the formatting. Use <LATEX> and </LATEX> tags to enclose the LaTeX content, do not use ```latex or ```.
            Take note of direction of arrows, placement of labels, and other notations. Assume that major math libraries are available, so you can use them to re-create the content. Here is an example:
