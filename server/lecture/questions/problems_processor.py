...
class ProblemsProcessor(BaseProcessor):
    def __init__(self, *args, **kwargs):
        ...
        will be questions for each lecture, similar to the notes. As we generate problems, we will add them to the dictionary. Have 2 types for each question, 'conceptual' and 'computational'. For now, just MCQ. Have 4 sections, 'question', 'options', 'answer', and 'explanation'.
