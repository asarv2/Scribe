...
class SlideProcessor:
    def __init__(self, course, course_title, handwritten=False):
        self.course = course
        self.course_title = course_title
        self.handwritten = handwritten
        self.output_dir = f'./output/output_{course}'
        self.notes_dir = f'/Users/ashoksaravanan/Coding/ScribeLec/server/summary/parse/Notes/Notes_{course}/'
    ...
    def process_slides(self, num_docs=None, num_slides=None, overwrite=False):
        ...
        for pdf_file in pdf_files:
            try:
                ...
                try:
                    ...
                    # Base prompt
                    if self.handwritten:
                        base_prompt = f"Extract exactly what is written on the handwritten notes, in the context of the course: {self.course_title}. Output the content in LaTeX format, preserving the formatting of the slide. For any figures you see, try to re-create them in LaTeX. Take note of direction of arrows, placement of labels, and other notations. Below the generation, provide a description of what you see: include specific details that would not be known unless you were given the context of the slide."
                    else:
                        ...
                        while True:
                            try:
                                ...
                                if "payload" in str(e).lower():
                                    ...
                                    conversation_history = self.prepare_conversation_history(conversation_history)
                    ...
                    output_file = os.path.join(self.output_dir, f"{pdf_file.replace('.pdf', '')}.txt")
...
if __name__ == "__main__":
    ...
    processor = SlideProcessor(args.course, args.course_title, args.handwritten)
